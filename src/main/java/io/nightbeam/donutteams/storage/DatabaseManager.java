...
public final class DatabaseManager {
    ...
    public static DatabaseManager fromSettings(JavaPlugin plugin, PluginSettings settings) {
        ...
        hikari.setJdbcUrl("jdbc:sqlite:" + new File(dataFolder, settings.sqliteFile()).getAbsolutePath());
        ...
        return new DatabaseManager(plugin, DatabaseType.SQLITE, new HikariDataSource(hikari));
    }
    ...
    public void initialize() throws SQLException {
        ...
        plugin.getLogger().info("Donut Teams storage ready (SQLITE).");
    }
